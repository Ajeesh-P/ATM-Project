...
public class ATMPinChange extends javax.swing.JFrame {
    ...
    public ATMPinChange(String cardNo, String accountId){
        initComponents();
        this.cardNo = cardNo;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String newPin2 = jTextField2.getText();
        if(newPin.equals(newPin2)){
            try {
                String sql = "update `atm-request` "
                        + "set pin = " + newPin
                        + " where cardno = " + cardNo;
                ...
                ATMHome aTMHome = new ATMHome();
                aTMHome.setVisible(true);
                JOptionPane jOptionPane = new JOptionPane("PIN changed", JOptionPane.OK_OPTION);
                JDialog dialog = jOptionPane.createDialog("Sucess");
                dialog.setVisible(true);
                this.setVisible(false);
            } catch (SQLException ex) {
                Logger.getLogger(ATMPinChange.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
            JOptionPane jOptionPane = new JOptionPane("PIN's don't match", JOptionPane.ERROR_MESSAGE);
